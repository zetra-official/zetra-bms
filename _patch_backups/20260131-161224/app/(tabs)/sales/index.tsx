    ...
    <Screen bottomPad={140}>
      <View style={{ flex: 1, gap: 14 }}>
        ...
        <Card style={{ gap: 10 }}>
          ...
          >
            <View>
              <Text style={{ color: theme.colors.muted, fontWeight: "800" }}>Cart</Text>
            ...
            >
              <Text style={{ color: theme.colors.text, fontWeight: "800" }}>Clear</Text>
            </Pressable>
          </View>
                ...
                <Card style={{ marginBottom: 12 }}>
                  <View style={{ flexDirection: "row", gap: 12 }}>
                    ...
                    {qty <= 0 ? (
                      ...
                      >
                        <Ionicons name="add" size={18} color={theme.colors.emerald} />
